...
mod tests {
    ...
    fn constructing_a_2fmatrix() {
        let matrix1 = Matrix::from([[-3.0, 5.0], [1.0, -2.0]]);
    ...
    fn constructing_a_3fmatrix() {
        let matrix1 = Matrix::from([[-3.0, 5.0, 0.0], [1.0, -2.0, -7.0], [0.0, 1.0, 1.0]]);
        assert_eq!(matrix1[0][0], -3.0);
        assert_eq!(matrix1[1][1], -2.0);
    ...
    fn comparing_3fmatrixes_true() {
        let matrix1 = Matrix::from([[-3.0, 5.0, 0.0], [1.0, -2.0, -7.0], [0.0, 1.0, 1.0]]);
        let matrix2 = Matrix::from([[-3.0, 5.0, 0.0], [1.0, -2.0, -7.0], [0.0, 1.0, 1.0]]);
        assert!(matrix1.fuzzy_eq(matrix2));
    }
    #[test]
    fn comparing_2fmatrixes_true() {
        let matrix1 = Matrix::from([[-3.0, 5.0], [1.0, -2.0]]);
        let matrix2 = Matrix::from([[-3.0, 5.0], [1.0, -2.0]]);
        assert!(matrix1.fuzzy_eq(matrix2));
    }
    #[test]
    ...
    fn determinant_of_a_2f_matrix() {
        let mat1 = Matrix::from([[1.0, 5.0], [-3.0, 2.0]]);
        let expected_res = 17.0;
        assert_eq!(mat1.determinant(), expected_res);
    }
    #[test]
    fn submatrix_of_matrix3f() {
        let matrix1 = Matrix::from([[1.0, 5.0, 0.0], [-3.0, 2.0, 7.0], [0.0, 6.0, -3.0]]);
        let expected_res = Matrix::from([[-3.0, 2.0], [0.0, 6.0]]);
    ...
    fn submatrix_of_matrix4f() {
        ...
        let expected_res = Matrix::from([[-6.0, 1.0, 6.0], [-8.0, 8.0, 6.0], [-7.0, -1.0, 1.0]]);
        let actual_res = matrix1.submatrix(2, 1);
        assert!(actual_res.fuzzy_eq(expected_res));
    }
    #[test]
    fn minor_of_matrix3f() {
        let matrix1 = Matrix::from([[3.0, 5.0, 0.0], [2.0, -1.0, -7.0], [6.0, -1.0, 5.0]]);
    ...
    fn determinant_of_matrix43() {
        let matrix1 = Matrix::from([[1.0, 2.0, 6.0], [-5.0, 8.0, -4.0], [2.0, 6.0, 4.0]]);
